...
| Name                                                                | Description                                  |
| ------------------------------------------------------------------- | -------------------------------------------- |
| [cpp](https://github.com/scruffaluff/templates/tree/main/cpp)       | C++ library and CLI application template.    |
| [python](https://github.com/scruffaluff/templates/tree/main/python) | Python library and CLI application template. |
| [rust](https://github.com/scruffaluff/templates/tree/main/rust)     | Rust library and CLI application template.   |
| [vue](https://github.com/scruffaluff/templates/tree/main/vue)       | VueJS single page application template.      |
