...
To setup the development environment, install [Just](https://just.systems), a
C++ compiler, and [LLDB](https://lldb.llvm.org) for debugging. From the project
...
This project is configured for automated CI on {% if cookiecutter.__project_githost == "bitbucket" %}Bitbucket Pipelines{%- elif cookiecutter.__project_githost == "github" %}GitHub Actions{%- else %}GitLab CI{%- endif %}.
